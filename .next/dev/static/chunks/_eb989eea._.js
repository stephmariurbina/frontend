...
async function addUserAddress(address, token) {
...
async function getUserAddresses(token) {
    return apiRequest("/user/misDirecciones", {
        headers: token ? {
            Authorization: `Bearer ${token}`
        } : {}
    });
}
async function trackPackage(codigo) {
    return apiRequest(`/user/tracking/${codigo}`);
}
async function registerManager(data, token) {
    return apiRequest("/admin/manager/register", {
        method: "POST",
        body: JSON.stringify(data),
        headers: token ? {
            Authorization: `Bearer ${token}`
...
async function updateManager(email, data, token) {
    return apiRequest(`/admin/manager/update/${encodeURIComponent(email)}`, {
        method: "PUT",
        body: JSON.stringify(data),
        headers: token ? {
            Authorization: `Bearer ${token}`
...
async function deleteManager(email, token) {
...
async function getManagerRoles(token) {
    return apiRequest("/admin/manager/roles", {
        headers: token ? {
            Authorization: `Bearer ${token}`
        } : {}
    });
}
async function createPackage(data, token) {
    return apiRequest("/admin/paquetes/crear", {
        method: "POST",
        body: JSON.stringify(data),
        headers: token ? {
            Authorization: `Bearer ${token}`
...
async function getPackagesReports(token) {
    return apiRequest("/admin/paquetes/reportes", {
        headers: token ? {
            Authorization: `Bearer ${token}`
        } : {}
    });
}
async function getCourierPackages(token) {
    return apiRequest("/courier/paquetes", {
        headers: token ? {
            Authorization: `Bearer ${token}`
        } : {}
    });
}
async function updatePackageStatus(id, data, token) {
    return apiRequest(`/courier/paquetes/${id}`, {
        method: "PUT",
        body: JSON.stringify(data),
        headers: token ? {
            Authorization: `Bearer ${token}`
...
const buildFullName = (nameFields)=>{
    const parts = [
...
function AuthProvider({ children }) {
    ...
    const login = async (email, password)=>{
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginUser"])({
            email,
            password
        });
        if (error || !data) {
    ...
    const registerUser = async (email, password, nameFields, role, department, phone)=>{
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerManager"])({
            email,
            password,
    ...
    const registerCustomer = async (email, password, nameFields)=>{
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerUser"])({
            email,
            password,
            firstName: nameFields.firstName,
            secondName: nameFields.secondName,
    ...
    const removeUser = async (email)=>{
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteManager"])(email, user?.token);
        if (error) {
            return {
                success: false,
                error
    ...
    const updateUserStatus = async (email, isActive)=>{
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateManager"])(email, {
