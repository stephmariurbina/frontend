...
function AuthProvider({ children }) {
    ...
    const login = async (email, password)=>{
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginUser"])({
            email,
            password
        });
        if (error || !data) {
    ...
    const registerUser = async (email, password, nameFields, role, department, phone)=>{
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registerManager"])({
            email,
            password,
    ...
    const registerCustomer = async (email, password, nameFields)=>{
        const { data, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registerUser"])({
            email,
            password,
            firstName: nameFields.firstName,
            secondName: nameFields.secondName,
    ...
    const removeUser = async (email)=>{
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteManager"])(email, user?.token);
        if (error) {
            return {
                success: false,
                error
    ...
    const updateUserStatus = async (email, isActive)=>{
        const { error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateManager"])(email, {
